...
const String MONO = "M";
const String IN_PHASE = "|";
const String OUT_OF_PHASE = "--";
...
const String LOOPS_FOR_DISPLAY[8] = {A_LOOP_POS, B_LOOP_POS, C_LOOP_POS, D_LOOP_POS, E_LOOP_POS, F_LOOP_POS, G_LOOP_POS,DRY_SEND};
